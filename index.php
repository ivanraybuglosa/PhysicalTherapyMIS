...
$password=$_POST['password'];
  $mysqli = new mysqli("localhost", "root", "", "ptmisdb");
      ...
      <form class="login-form" method="post" >
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <p class="center login-form-text">BAGO PHYSICAL THERAPY </p>
            <p class="center login-form-text">REHAB CARE CENTER - PTMIS</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="input-field col s12">
            <button type="submit" name="login" class="btn waves-effect waves-light red col s12">Login</button>
          </div>
        </div>
      </form>
    </div>
