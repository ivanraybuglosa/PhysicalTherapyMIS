                                            ...
                                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                                ...
                                                $result = mysqli_query($mysqli, "SELECT * FROM patient ORDER BY PatientID");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="referralAdd.php?Patient_ID=<?php echo $res['PatientID']; ?>" data-toggle="modal" class="waves-effect waves-light modal-trigger light-blue btn"> Add Referral </a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
