                    ...
                    <div class="container">
                        <div class="section">
                            ...
                            <div id="table-datatables">
                                <h4 class="header2">Please Select Patient</h4>
                                    <div class="row">
                                        <div class="col s12 m8 l12">
                                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <?php $result1 = mysqli_query($mysqli, "SELECT * FROM patient");
                                                    while ($res1 = mysqli_fetch_array($result1)) { ?>
                                                        <td><?php echo $res1['PatientName']; ?></td> 
                                                        
                                                        
                                                        <td><a href="referralAdd.php?Patient_ID=<?php echo $res1['PatientID']; ?>" class="waves-effect waves-light light-blue btn" >Add Referral</button>
                                                         </td>
